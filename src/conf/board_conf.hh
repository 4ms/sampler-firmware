...
using PlayLED = MixedRgbLed<PlayR, PlayG, PlayB>;
...
using RevLED = MixedRgbLed<RevR, RevG, RevB>;
...
using BankLED = MixedRgbLed<BankR, BankG, BankB>;
...
using PlayPWM = MixedRgbLed<PlayR50, PlayGPwm, PlayBPwm, LEDUpdateRateHz>;
...
using RevPWM = MixedRgbLed<RevR50, RevGPwm, RevBPwm, LEDUpdateRateHz>;
...
using BankPWM = MixedRgbLed<BankRPwm, BankGPwm, BankBPwm, LEDUpdateRateHz>;
#else
using BankB50 = mdrivlib::Led50<BrainPin::D5.gpio, BrainPin::D5.pin, Inverted>;
using BankPWM = MixedRgbLed<BankRPwm, BankGPwm, BankB50, LEDUpdateRateHz>;
#endif
